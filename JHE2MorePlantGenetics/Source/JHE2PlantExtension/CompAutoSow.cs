...
{
    public class CompAutoSow : ThingComp
    {
        ...
        {
            if (Find.TickManager.TicksGame >= nextSubplantTick && ((Plant)parent).Growth >= Props.minGrowthForSpawn)
            {
        ...
        public void DoGrowSubplant(bool force = false)
        {
            ...
            for (int i = 0; i < num; i++)
            {
                ...
                Plant plant2 = (Plant)GenSpawn.Spawn(parent.def, intVec, parent.Map);
        ...
        public override string CompInspectStringExtra()
        {
            ...
            if (((Plant)parent).Growth >= Props.minGrowthForSpawn)
            {
                stringBuilder.Append("JHE2_AutoSowingNext".Translate(((Find.TickManager.TicksGame - nextSubplantTick) * -1).ToStringTicksToPeriod()));
            }
            else
            {
                stringBuilder.Append("JHE2_AutoSowingCan".Translate(" " + Props.minGrowthForSpawn+"%"));
            }
